...
function VerticalPicker(_a) {
    var minimumValue = _a.minimumValue, maximumValue = _a.maximumValue, onChangeValue = _a.onChangeValue, customRenderItem = _a.customRenderItem, thumbElement = _a.thumbElement, focusValue = _a.focusValue, _b = _a.visibleItemCount, visibleItemCount = _b === void 0 ? 20 : _b;
    var flatList = useRef(null);
    var _c = useState(0), oneItemHeight = _c[0], setOneItemHeight = _c[1];
    var _d = useState(0), thumbHeight = _d[0], setThumbHeight = _d[1];
