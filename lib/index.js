...
function VerticalPicker(_a) {
    var minimumValue = _a.minimumValue, maximumValue = _a.maximumValue, onChangeValue = _a.onChangeValue, customRenderItem = _a.customRenderItem, thumbElement = _a.thumbElement, focusValue = _a.focusValue;
    var flatList = useRef(null);
    var _b = useState(0), oneItemHeight = _b[0], setOneItemHeight = _b[1];
